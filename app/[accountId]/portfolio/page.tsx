                    ...
                    <div className="px-0 mt-4 md:mt-0 lg:px-8">
                        <Tabs defaultValue="Projects" className="w-full">
                            ...
                            <TabsContent value="Projects">
                                <ScrollArea className="h-[700px] w-full sm:px-2 rounded-md ">
                                    {
                                        projects.map(({title,badges,image,description},index) => {
                                            return(
                                                <DetailCard key={index} title={title} image={image} description={description} badges={badges} />
                                            )
                                        })
                                    }
                                </ScrollArea>
