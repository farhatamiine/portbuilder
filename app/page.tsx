        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Build a professional portfolio that stands out. Showcase your
              projects and skills with our intuitive design tools and get
              noticed by top employers and clients.
            </p>
